...
public class OperationalAgent extends CommonElement implements UAFElement {
	...
	public OperationalAgent(String name, String EAID) {
		...
		this.sysmlConstant = UAFConstants.OPERATIONAL_AGENT;
		this.xmlConstant = XmlTagConstants.OPERATIONAL_AGENT;
		this.creationProfile = StereotypesHelper.getProfile(ImportXmlSysml.getProject(), UAFConstants.UAF_PROFILE_NAME); 
		this.creationStereotype = StereotypesHelper.getStereotype(ImportXmlSysml.getProject(), UAFConstants.OPERATIONAL_AGENT, creationProfile);
	}
}
