...
public class OperationalMessage extends Message {

	public OperationalMessage(String name, String EAID) {
		super(name, EAID);
		this.creationType = XmlTagConstants.ELEMENTSFACTORY;
		this.sysmlConstant = UAFConstants.OPERATIONAL_MESSAGE;
		this.xmlConstant = XmlTagConstants.OPERATIONAL_MESSAGE;
