...
public class NaturalResource extends CommonElement implements UAFElement {
	...
	public NaturalResource(String name, String EAID) {
		...
		this.sysmlConstant = UAFConstants.NATURAL_RESOURCE;
		...
		this.creationStereotype = StereotypesHelper.getStereotype(ImportXmlSysml.getProject(), UAFConstants.NATURAL_RESOURCE, creationProfile);
	}
}
