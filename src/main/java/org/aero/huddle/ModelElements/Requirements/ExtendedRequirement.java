...
public class ExtendedRequirement extends CommonElement {
	...
	public Element createElement(Project project, Element owner, XMLItem xmlElement) {
		if (!SessionManager.getInstance().isSessionCreated(project)) {
			SessionManager.getInstance().createSession(project, "Create Extended Requirement Element");
		}
		
		Profile sysmlProfile = StereotypesHelper.getProfile(project, "SysML");
		Stereotype requirementStereotype = StereotypesHelper.getStereotype(project,  "extendedRequirement", sysmlProfile);
	...
	public void writeToXML(Element element, Project project, Document xmlDoc) {
		...
		type.appendChild(xmlDoc.createTextNode(XmlTagConstants.EXTENDEDREQUIREMENT));
