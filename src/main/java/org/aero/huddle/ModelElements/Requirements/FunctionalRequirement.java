...
public class FunctionalRequirement extends CommonElement {
	...
	public Element createElement(Project project, Element owner, XMLItem xmlElement) {
		if (!SessionManager.getInstance().isSessionCreated(project)) {
			SessionManager.getInstance().createSession(project, "Create Functional Requirement Element");
		}
	...
	public void writeToXML(Element element, Project project, Document xmlDoc) {
		...
		type.appendChild(xmlDoc.createTextNode(XmlTagConstants.FUNCTIONALREQUIREMENT));
