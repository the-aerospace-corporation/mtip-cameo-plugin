...
public class ConstraintProperty extends CommonElement {
	...
	public Element createElement(Project project, Element owner, XMLItem xmlElement) {
		...
		if (!SessionManager.getInstance().isSessionCreated(project)) {
			SessionManager.getInstance().createSession(project, "Create Constraint Property Element");
		}
	...
	public void writeToXML(Element element, Project project, Document xmlDoc) {
		...
		type.appendChild(xmlDoc.createTextNode(XmlTagConstants.CONSTRAINTPROPERTY));
