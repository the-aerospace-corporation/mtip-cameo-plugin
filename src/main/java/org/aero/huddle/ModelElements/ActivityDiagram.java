...
public class ActivityDiagram extends CommonElement implements ModelDiagram{
	...
	public Element createElement(Project project, Element owner, XMLItem xmlElement) {
		...
		try {
			...
			sysmlElement = ModelElementsManager.getInstance().createDiagram(DiagramTypeConstants.UML_ACTIVITY_DIAGRAM,
					(Namespace) owner);
