...
public class DecisionNode extends ActivityNode {
	...
	public void createReferencedElements(HashMap<String, XMLItem> parsedXML, XMLItem modelElement) {
		...
		Element decisionInput = Importer.getInstance().buildElement(parsedXML, parsedXML.get(modelElement.getAttribute(XmlTagConstants.ATTRIBUTE_NAME_DECISION_INPUT)));
