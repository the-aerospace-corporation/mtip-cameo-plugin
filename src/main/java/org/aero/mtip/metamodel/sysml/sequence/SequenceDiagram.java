...
public class SequenceDiagram  extends AbstractDiagram {
	...
	protected void addRelationshipToDiagram(DiagramPresentationElement presentationDiagram, Element relationship) {
	  try {
	...
	protected Message addMessageToDiagram(DiagramPresentationElement presentationDiagram, Message message, Message previousMessage) {
	  try {
	...
	private void createDurationConstraintView(Element relationship) {
