...
//	public static Stereotype ASSOCIATION_BLOCK = 
	...
	public static Stereotype getFlowSpecificationStereotype() {
		return getInstance().getStereotype(FLOW_SPECIFICATION_NAME);
	}
	
	public static Stereotype getProxyPortStereotype() {
		return getInstance().getStereotype(PROXY_PORT_NAME);
	}
	...
	public static Stereotype getUsabilityRequirementStereotype() {
	  return getInstance().getStereotype(USABILITY_REQUIREMENT_NAME);
	}
