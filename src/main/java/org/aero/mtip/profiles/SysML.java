...
public class SysML {
  ...
  public static Stereotype getCopyStereotype() {
    return getInstance().getStereotype(COPY_NAME);
  }
  ...
  public static Stereotype getFlowSpecificationStereotype() {
    return StereotypesHelper.getStereotype(getInstance().project, FLOW_SPECIFICATION_NAME,
        getInstance().profile);
  }
