...
public class CameoDiagramConstants {
	...
	public static final String ACTUAL_RESOURCES_STRUCTURE = "Actual Resources Structure";
	
	// Operational
	public static final String OPERATIONAL_CONNECTIVITY = "Operational Connectivity";
