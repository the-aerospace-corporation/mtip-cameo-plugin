...
public class Standard extends CommonElement implements UAFElement{
	public Standard (String name, String EAID) {
		...
		this.sysmlConstant = UAFConstants.STANDARD;
		...
		this.creationStereotype = StereotypesHelper.getStereotype(ImportXmlSysml.getProject(), UAFConstants.STANDARD, creationProfile);
	}
