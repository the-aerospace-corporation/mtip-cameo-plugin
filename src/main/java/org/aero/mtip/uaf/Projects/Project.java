...
public class Project extends CommonElement implements UAFElement {
	...
	public Project(String name, String EAID) {
		...
		this.sysmlConstant = UAFConstants.PROJECT;
		...
		this.creationStereotype = StereotypesHelper.getStereotype(ImportXmlSysml.getProject(), UAFConstants.PROJECT, creationProfile);
	}
}
