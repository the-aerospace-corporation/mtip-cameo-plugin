...
public class Technology extends CommonElement implements UAFElement {
	...
	public Technology(String name, String EAID) {
		...
		this.sysmlConstant = UAFConstants.TECHNOLOGY;
		...
		this.creationStereotype = StereotypesHelper.getStereotype(ImportXmlSysml.getProject(), UAFConstants.TECHNOLOGY, creationProfile);
	}
}
