...
public class ResourceArchitecture extends CommonElement implements UAFElement {
	...
	public ResourceArchitecture(String name, String EAID) {
		...
		this.sysmlConstant = UAFConstants.RESOURCE_ARCHITECTURE;
		...
		this.creationStereotype = StereotypesHelper.getStereotype(ImportXmlSysml.getProject(), UAFConstants.RESOURCE_ARCHITECTURE, creationProfile);
	}
}
